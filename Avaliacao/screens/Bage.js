...
const DATA = [
  {
    ...
    imageUri:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Vista_dos_cerros_de_Bag%C3%A9_-_51245306778.jpg/270px-Vista_dos_cerros_de_Bag%C3%A9_-_51245306778.jpg",
  ...
  },
  {
    ...
    populacao: "150.000",
    imageUri:
      "https://i0.wp.com/www.rgstur.com/wp-content/uploads/2014/04/bage-rs.jpg?fit=1024%2C768&ssl=1",
  },
  {
...
const BageApp = () => {
  ...
  const total = (item) => {
    if (item.id == "bd7acbea-c1b1-46c2-aed5-3ad53abb28ba") {
      ...
      Speech.speak("População cento e cinquenta mil:");
    } else {
      Speech.speak("Pib de cinco milhoes");
    }
  };
